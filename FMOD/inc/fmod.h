...
FMOD_RESULT F_API FMOD_Channel_GetDSPClock           (FMOD_CHANNEL *channel, unsigned int *dspclock, unsigned int *parentclock);
FMOD_RESULT F_API FMOD_Channel_SetDelay              (FMOD_CHANNEL *channel, unsigned int dspclock_start, unsigned int dspclock_end, FMOD_BOOL stopchannels);
FMOD_RESULT F_API FMOD_Channel_GetDelay              (FMOD_CHANNEL *channel, unsigned int *dspclock_start, unsigned int *dspclock_end, FMOD_BOOL *stopchannels);
FMOD_RESULT F_API FMOD_Channel_AddFadePoint          (FMOD_CHANNEL *channel, unsigned int dspclock, float volume);
FMOD_RESULT F_API FMOD_Channel_RemoveFadePoints      (FMOD_CHANNEL *channel, unsigned int dspclock_start, unsigned int dspclock_end);
FMOD_RESULT F_API FMOD_Channel_GetFadePoints         (FMOD_CHANNEL *channel, unsigned int *numpoints, unsigned int *point_dspclock, float *point_volume);
...
FMOD_RESULT F_API FMOD_ChannelGroup_AddGroup         (FMOD_CHANNELGROUP *channelgroup, FMOD_CHANNELGROUP *group, FMOD_BOOL propagatedspclock);
...
FMOD_RESULT F_API FMOD_DSP_AddInput                  (FMOD_DSP *dsp, FMOD_DSP *input, unsigned int priority, FMOD_DSPCONNECTION **connection, FMOD_DSPCONNECTION_TYPE type);
...
FMOD_RESULT F_API FMOD_DSP_GetOuputChannelFormat     (FMOD_DSP *dsp, FMOD_CHANNELMASK inmask, int inchannels, FMOD_SPEAKERMODE inspeakermode, FMOD_CHANNELMASK *outmask, int *outchannels, FMOD_SPEAKERMODE *outspeakermode);
...
FMOD_RESULT F_API FMOD_DSP_SetParameterData          (FMOD_DSP *dsp, int index, void *value, unsigned int length);
...
FMOD_RESULT F_API FMOD_DSP_GetParameterData          (FMOD_DSP *dsp, int index, void **value, unsigned int *length, char *valuestr, int valuestrlen);
...
FMOD_RESULT F_API FMOD_DSP_GetParameterInfo2         (FMOD_DSP *dsp, int index, FMOD_DSP_PARAMETER_DESC **desc);
...
FMOD_RESULT F_API FMOD_Reverb3D_GetMemoryInfo        (FMOD_REVERB3D *reverb3d, unsigned int memorybits, unsigned int event_memorybits, unsigned int *memoryused, FMOD_MEMORY_USAGE_DETAILS *memoryused_details);
/*$ preserve start $*/
