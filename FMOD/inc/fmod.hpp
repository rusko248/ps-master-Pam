    ...
    */
    class ChannelControl
    {
      ...
      public:
        ...
        FMOD_RESULT F_API getDSPClock            (unsigned int *dspclock, unsigned int *parentclock);
        FMOD_RESULT F_API setDelay               (unsigned int dspclock_start, unsigned int dspclock_end, bool stopchannels = true);
        FMOD_RESULT F_API getDelay               (unsigned int *dspclock_start, unsigned int *dspclock_end, bool *stopchannels = 0);
        FMOD_RESULT F_API addFadePoint           (unsigned int dspclock, float volume);
        FMOD_RESULT F_API removeFadePoints       (unsigned int dspclock_start, unsigned int dspclock_end);
        FMOD_RESULT F_API getFadePoints          (unsigned int *numpoints, unsigned int *point_dspclock, float *point_volume);
    ...
    */
    class DSP
    {
      ...
      public:
        ...
        FMOD_RESULT F_API addInput               (DSP *input, unsigned int priority = 0, DSPConnection **connection = 0, FMOD_DSPCONNECTION_TYPE type = FMOD_DSPCONNECTION_TYPE_STANDARD);
        ...
        FMOD_RESULT F_API getOuputChannelFormat  (FMOD_CHANNELMASK inmask, int inchannels, FMOD_SPEAKERMODE inspeakermode, FMOD_CHANNELMASK *outmask, int *outchannels, FMOD_SPEAKERMODE *outspeakermode);
        ...
        FMOD_RESULT F_API setParameterData       (int index, void *value, unsigned int length);
        ...
        FMOD_RESULT F_API getParameterData       (int index, void **value, unsigned int *length, char *valuestr, int valuestrlen);
        ...
        FMOD_RESULT F_API getParameterInfo2      (int index, FMOD_DSP_PARAMETER_DESC **desc);
